    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                ...
                <a target="_blank" rel="noreferrer"><h2>Nocturnal Enigma <br></br> (Final Major Project)</h2></a>
            ...
            <div className="project">
                ...
                <a target="_blank" rel="noreferrer"><h2>EUPNEA – Breath Freely <br></br> (Contemporary Locomotion Collection)</h2></a>
            ...
            <div className="project">
                ...
                <a target="_blank" rel="noreferrer"><h2>DILIGANZ 'IDOLS' <br></br> (Special Project)</h2></a>
            ...
            <div className="project">
                ...
                <a target="_blank" rel="noreferrer"><h2>RANSALU All-Island Textile Design Competition</h2></a>
            ...
            <div className="project">
                ...
                <a target="_blank" rel="noreferrer"><h2> Catharsis (Simulated Studio Practice)<br></br> </h2></a>
            ...
            <div className="project">
                ...
                <a target="_blank" rel="noreferrer"><h2>Graduation Photoshoots – Creative Direction</h2></a>
